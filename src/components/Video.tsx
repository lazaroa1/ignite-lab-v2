    ...
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              <img
                ...
                src="https://github.com/lazaroa1.png"
                alt=""
              />
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          <a
            href=""
            className="bg-gray-700 rounded oveflow-hidden flex items-strech gap-6 hover:bg-gray-600 transition-colors"
          >
